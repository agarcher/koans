...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments_with_wrong_number_of_arguments
    # TODO: Start new tests to contribute
    assert_equal [1,2,3], method_with_keyword_arguments_with_mandatory_argument(1)
    assert_equal ["one",2,"three"], method_with_keyword_arguments_with_mandatory_argument("one", three: "three")
    # TODO: End new
