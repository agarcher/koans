...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Array#inject runs an operation against each element in the collection
    # passing the result to the next element and returning the end result
  end
  ...
  #   # code to read 'file'
  #
  # I have no way to know the answer, but I assume it's because using a do block
  # will ensure the OS handles are released automatically when the do block terminates
  #
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
  # Yes, it's because the File.open code handles closing the file on completion of the block
